"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[570],{7527:function(e,t,i){i.d(t,{a0:function(){return eG},a6:function(){return eJ},n:function(){return tG}});var r,n=i(4444),s=i(2238),a=i(3333),o=i(655),l=i(8463);function u(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let c=new n.LL("auth","Firebase",u()),d=new a.Yd("@firebase/auth");function h(e,...t){d.logLevel<=a.in.ERROR&&d.error(`Auth (${s.SDK_VERSION}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function e2(){return void 0!==e3().WorkerGlobalScope&&"function"==typeof e3().importScripts}async function e4(){if(!(null==navigator?void 0:navigator.serviceWorker))return null;try{let e=await navigator.serviceWorker.ready;return e.active}catch(t){return null}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
