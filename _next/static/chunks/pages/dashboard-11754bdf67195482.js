 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e=navigator){return e.languages&&e.languages[0]||e.language}()},h={method:"POST",headers:l,body:JSON.stringify(c)},u=fetch(o,h),g=new Promise((t,s)=>{e.signal.addEventListener(()=>{let e=Error("The operation was aborted.");e.name="AbortError",s(e)})});try{await Promise.race([u,g]),t=await u}catch(d){let m="fetch-client-network";throw(null==d?void 0:d.name)==="AbortError"&&(m="fetch-timeout"),_.create(m,{originalErrorMessage:null==d?void 0:d.message})}let f=t.status,p=t.headers.get("ETag")||void 0;if(200===t.status){let w;try{w=await t.json()}catch(x){throw _.create("fetch-client-parse",{originalErrorMessage:null==x?void 0:x.message})}s=w.entries,i=w.state}if("INSTANCE_STATE_UNSPECIFIED"===i?f=500:"NO_CHANGE"===i?f=304:("NO_TEMPLATE"===i||"EMPTY_CONFIG"===i)&&(s={}),304!==f&&200!==f)throw _.create("fetch-status",{httpStatus:f});return{status:f,eTag:p,config:s}}}class T{constructor(e,t){this.client=e,this.storage=t}async fetch(e){let t=await this.storage.getThrottleMetadata()||{backoffCount:0,throttleEndTimeMillis:Date.now()};return this.attemptFetch(e,t)}async attemptFetch(e,{throttleEndTimeMillis:t,backoffCount:s}){var i;await (i=e.signal,new Promise((e,s)=>{let a=Math.max(t-Date.now(),0),r=setTimeout(e,a);i.addEventListener(()=>{clearTimeout(r),s(_.create("fetch-throttle",{throttleEndTimeMillis:t}))})}));try{let a=await this.client.fetch(e);return await this.storage.deleteThrottleMetadata(),a}catch(n){if(!function(e){if(!(e instanceof u.ZR)||!e.customData)return!1;let t=Number(e.customData.httpStatus);return 429===t||500===t||503===t||504===t}(n))throw n;let r={throttleEndTimeMillis:Date.now()+(0,u.$s)(s),backoffCount:s+1};return await this.storage.setThrottleMetadata(r),this.attemptFetch(e,r)}}}class E{constructor(e,t,s,i,a){this.app=e,this._client=t,this._storageCache=s,this._storage=i,this._logger=a,this._isInitializationComplete=!1,this.settings={fetchTimeoutMillis:6e4,minimumFetchIntervalMillis:432e5},this.defaultConfig={}}get fetchTimeMillis(){return this._storageCache.getLastSuccessfulFetchTimestampMillis()||-1}get lastFetchStatus(){return this._storageCache.getLastFetchStatus()||"no-fetch-yet"}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function N(e,t){let s=e.target.error||void 0;return _.create(t,{originalErrorMessage:s&&(null==s?void 0:s.message)})}let j="app_namespace_store";class k{constructor(e,t,s,i=new Promise((e,t)=>{try{let s=indexedDB.open("firebase_remote_config",1);s.onerror=e=>{t(N(e,"storage-open"))},s.onsuccess=t=>{e(t.target.result)},s.onupgradeneeded=e=>{let t=e.target.result;0===e.oldVersion&&t.createObjectStore(j,{keyPath:"compositeKey"})}}catch(i){t(_.create("storage-open",{originalErrorMessage:null==i?void 0:i.message}))}})){this.appId=e,this.appName=t,this.namespace=s,this.openDbPromise=i}getLastFetchStatus(){return this.get("last_fetch_status")}setLastFetchStatus(e){return this.set("last_fetch_status",e)}getLastSuccessfulFetchTimestampMillis(){return this.get("last_successful_fetch_timestamp_millis")}setLastSuccessfulFetchTimestampMillis(e){return this.set("last_successful_fetch_timestamp_millis",e)}getLastSuccessfulFetchResponse(){return this.get("last_successful_fetch_response")}setLastSuccessfulFetchResponse(e){return this.set("last_successful_fetch_response",e)}getActiveConfig(){return this.get("active_config")}setActiveConfig(e){return this.set("active_config",e)}getActiveConfigEtag(){return this.get("active_config_etag")}setActiveConfigEtag(e){return this.set("active_config_etag",e)}getThrottleMetadata(){return this.get("throttle_metadata")}setThrottleMetadata(e){return this.set("throttle_metadata",e)}deleteThrottleMetadata(){return this.delete("throttle_metadata")}async get(e){let t=await this.openDbPromise;return new Promise((s,i)=>{let a=t.transaction([j],"readonly"),r=a.objectStore(j),n=this.createCompositeKey(e);try{let o=r.get(n);o.onerror=e=>{i(N(e,"storage-get"))},o.onsuccess=e=>{let t=e.target.result;t?s(t.value):s(void 0)}}catch(l){i(_.create("storage-get",{originalErrorMessage:null==l?void 0:l.message}))}})}async set(e,t){let s=await this.openDbPromise;return new Promise((i,a)=>{let r=s.transaction([j],"readwrite"),n=r.objectStore(j),o=this.createCompositeKey(e);try{let l=n.put({compositeKey:o,value:t});l.onerror=e=>{a(N(e,"storage-set"))},l.onsuccess=()=>{i()}}catch(c){a(_.create("storage-set",{originalErrorMessage:null==c?void 0:c.message}))}})}async delete(e){let t=await this.openDbPromise;return new Promise((s,i)=>{let a=t.transaction([j],"readwrite"),r=a.objectStore(j),n=this.createCompositeKey(e);try{let o=r.delete(n);o.onerror=e=>{i(N(e,"storage-delete"))},o.onsuccess=()=>{s()}}catch(l){i(_.create("storage-delete",{originalErrorMessage:null==l?void 0:l.message}))}})}createCompositeKey(e){return[this.appId,this.appName,this.namespace,e].join()}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
