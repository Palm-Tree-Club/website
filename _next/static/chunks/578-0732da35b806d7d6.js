 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function y({appConfig:t,heartbeatServiceProvider:e},{fid:a}){let n=d(t),i=h(t),r=e.getImmediate({optional:!0});if(r){let o=await r.getHeartbeatsHeader();o&&i.append("x-firebase-client",o)}let s={fid:a,authVersion:f,appId:t.appId,sdkVersion:l},u={method:"POST",headers:i,body:JSON.stringify(s)},c=await m(()=>fetch(n,u));if(c.ok){let p=await c.json(),y={fid:p.fid||a,registrationStatus:2,refreshToken:p.refreshToken,authToken:g(p.authToken)};return y}throw await w("Create Installation",c)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function E({appConfig:t,heartbeatServiceProvider:e},a){let n=function(t,{fid:e}){return`${d(t)}/${e}/authTokens:generate`}(t,a),i=function(t,{refreshToken:e}){let a=h(t);return a.append("Authorization",`${f} ${e}`),a}(t,a),r=e.getImmediate({optional:!0});if(r){let o=await r.getHeartbeatsHeader();o&&i.append("x-firebase-client",o)}let s={installation:{sdkVersion:l,appId:t.appId}},u={method:"POST",headers:i,body:JSON.stringify(s)},c=await m(()=>fetch(n,u));if(c.ok){let p=await c.json(),y=g(p);return y}throw await w("Generate Auth Token",c)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
