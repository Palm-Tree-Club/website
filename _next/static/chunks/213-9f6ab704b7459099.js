 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function x(t,e=!1){let n;let r=await j(t.appConfig,r=>{var i;if(!z(r))throw f.create("not-registered");let a=r.authToken;if(!e&&2===(i=a).requestStatus&&!function(t){let e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+36e5}(i))return r;if(1===a.requestStatus)return n=$(t,e),r;{if(!navigator.onLine)throw f.create("app-offline");let o=function(t){let e={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},t),{authToken:e})}(r);return n=H(t,o),o}}),i=n?await n:r.authToken;return i}async function $(t,e){let n=await B(t.appConfig);for(;1===n.authToken.requestStatus;)await w(100),n=await B(t.appConfig);let r=n.authToken;return 0===r.requestStatus?x(t,e):r}function B(t){return j(t,t=>{if(!z(t))throw f.create("not-registered");let e=t.authToken;return 1===e.requestStatus&&e.requestTime+1e4<Date.now()?Object.assign(Object.assign({},t),{authToken:{requestStatus:0}}):t})}async function H(t,e){try{let n=await R(t,e),r=Object.assign(Object.assign({},e),{authToken:n});return await M(t.appConfig,r),n}catch(a){if(d(a)&&(401===a.customData.serverCode||404===a.customData.serverCode))await k(t.appConfig);else{let i=Object.assign(Object.assign({},e),{authToken:{requestStatus:0}});await M(t.appConfig,i)}throw a}}function z(t){return void 0!==t&&2===t.registrationStatus}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function U(t){let{installationEntry:e,registrationPromise:n}=await A(t);return n?n.catch(console.error):x(t).catch(console.error),e.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function q(t,e=!1){await W(t);let n=await x(t,e);return n.token}async function W(t){let{registrationPromise:e}=await A(t);e&&await e}function K(t){return f.create("missing-app-config-values",{valueName:t})}/**
 * @license
