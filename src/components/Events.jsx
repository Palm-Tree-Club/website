            ...
            <div className="grid w-full px-28 grid-flow-col place-items-center">
                ...
                <div className="flex flex-col justify-evenly h-full items-center">
                    ...
                    <p className='text-xl text-bottle-text'>
                        <p><Image className='inline-flex' alt="calender" height={30} width={30} src="https://img.icons8.com/color/48/null/calendar--v3.png" /> : 28<sup>th</sup> Jan</p>
                        <p><Image alt='clock' height={30} width={30} className="inline-flex" src="https://img.icons8.com/fluency/48/null/time-span.png" /> : 11:00 am - 1:30 pm</p> 
