  ...
  return (
    <div id="faculty" className="select-none h-screen w-screen flex flex-col justify-center items-center bg-purple-800">
      ...
      <div className='w-screen m-14 flex justify-evenly items-center'>
        <img data-aos='fade-right' className="cursor-pointer" src='/Assets/Images/cards/dean.png' width={230} height={230} alt='Dean'/>
        <img data-aos='fade-up' className="cursor-pointer" src='/Assets/Images/cards/principal.png' width={230} height={230} alt='principal'/>
        <img data-aos='fade-down' className="cursor-pointer" src='/Assets/Images/cards/HOD.png' width={230} height={230} alt='HOD'/>
