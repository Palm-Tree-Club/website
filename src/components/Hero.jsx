...
export default function Hero() {
    return (
        <div id="hero" className="select-none grid h-screen bg-hero bg-cover w-screen max-sm:bg-center">
            <div  className="bg-opacity flex h-screen w-screen flex-col justify-center items-center font-sans col-span-2">
                ...
                <p className="text-white mt-16 text-3xl max-sm:text-3xl font-semibold text-grey">Learn | Build | Grow</p>
            </div>
        </div>
    )
}