  ...
  return (
    ...
    >
      <div className="bg-opacity flex h-screen w-screen flex-col justify-center items-center font-sans col-span-2">
        ...
        <h1 className="text-white text-6xl max-sm:text-3xl max-sm:text-center font-extrabold uppercase">
          <a
            href="https://silveroakuni.ac.in"
            target={"_blank"}
            className="hover:text-sky-700 transition duration-300 cursor-pointer"
            rel="noreferrer"
          >
            SOCCA&apos;s{" "}
          </a>
        ...
        <h1 className="mt-10 text-7xl max-sm:text-3xl uppercase font-bold text-ambers">
          Palm Tree Club
        </h1>
        <p className="text-white mt-16 text-3xl max-sm:text-3xl font-semibold text-grey">
          Learn | Build | Grow
        </p>
      </div>
    </div>
